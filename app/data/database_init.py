...
def initialize_database():
    ...
    stock_columns = {
        ...
        "macro_economic_sector": "VARCHAR(100)", "sector": "VARCHAR(100)", "industry": "VARCHAR(150)",
        "basic_industry": "VARCHAR(200)", "sector_code": "VARCHAR(30)", "industry_code": "VARCHAR(30)",
        "basic_industry_code": "VARCHAR(40)", "sector_source": "VARCHAR(50)",
    ...
    for column_name, column_type in fundamental_columns.items():
        _add_missing_column("company_fundamentals", column_name, column_type)
