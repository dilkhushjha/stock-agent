...
from app.api.regime import (
    router as regime_router,
)
from app.api.market_context import (
    router as market_context_router,
)
from app.api.sector import (
...
app = FastAPI(
    ...
    description="AI-powered Indian stock market intelligence and signal system",
    version="0.1.0",
    lifespan=lifespan,
)
